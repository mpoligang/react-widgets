import "../../../styles.css";
import { QInputCurrency, QButton } from "qilab-widgets/dist/react-widgets";
import { GenericInput } from "qilab-widgets/dist/models/generic-input";
import { useRef, useState } from "react";

export default function WidgetInputFloat() {
  const inputCurrencyComponent = useRef<GenericInput>(undefined);
  ...
  return (
    <div className="App">
      <h1>React Input Currency Widget</h1>
      <h3>Two Binding Way with Object</h3>
      <div className="container-input">
        <QInputCurrency
          ref={inputCurrencyComponent}
          id="QInputCurrency"
          name="property"
      ...
      <div className="container-actions">
        ...
        <QButton
          ...
          style={{ marginLeft: "1rem" }}
          onClick={() => {
            inputCurrencyComponent.current.hasError();
          }}
        ></QButton>
      </div>
    </div>
